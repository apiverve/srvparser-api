...
```gradle
dependencies {
    implementation 'com.github.apiverve:srvparser-api:1.1.12'
}
```
...
```java
import com.apiverve.srvparser.SRVRecordParserAPIClient;
import com.apiverve.srvparser.APIResponse;
import com.apiverve.srvparser.APIException;

// Initialize the client
SRVRecordParserAPIClient client = new SRVRecordParserAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/srvparser](https://docs.apiverve.com/ref/srvparser)
...
- **Documentation:** [https://docs.apiverve.com/ref/srvparser](https://docs.apiverve.com/ref/srvparser)
- **Issues:** [GitHub Issues](https://github.com/apiverve/srvparser-api/issues)
