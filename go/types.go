// Package srvparser provides a Go client for the SRV Record Parser API.
//
// For more information, visit: https://apiverve.com/marketplace/srvparser?utm_source=go&utm_medium=readme
package srvparser
...
// Request contains the parameters for the SRV Record Parser API.
//
// Parameters:
//   - record (required): string - The SRV record string to parse
type Request struct {
...
// ResponseData contains the data returned by the SRV Record Parser API.
type ResponseData struct {
	RawRecord string `json:"raw_record"`
	Parsed ParsedData `json:"parsed"`
	ServiceInfo ServiceInfoData `json:"service_info"`
...
// ServiceInfoData represents the service_info object.
...
type InterpretationData struct {
	...
	WeightExplanation string `json:"weight_explanation"`
	TargetExplanation string `json:"target_explanation"`
}
