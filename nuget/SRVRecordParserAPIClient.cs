...
namespace APIVerve.API.SRVRecordParser
{
    ...
    /// <summary>
    /// Client for the SRVRecordParser API
    /// </summary>
    public class SRVRecordParserAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/srvparser";
        ...
        public SRVRecordParserAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SRVRecordParserAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SRVRecordParserAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SRVRecordParserQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SRVRecordParserQueryOptions options)
        {
        ...
        public ResponseObj Execute(SRVRecordParserQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SRVRecordParserQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SRVRecordParserQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SRVRecordParserQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SRVRecordParserQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SRVRecordParserQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SRVRecordParserQueryOptions options)
        {
