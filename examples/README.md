# SRV Record Parser API - Examples

This folder contains example code for using the SRV Record Parser API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/srvparser',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/srvparser");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/srvparser](https://docs.apiverve.com/ref/srvparser)
