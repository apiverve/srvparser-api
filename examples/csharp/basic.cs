    ...
    class SRVRecordParserExample
    {
        ...
        static async Task<JsonDocument> CallSRVRecordParserAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { record &#x3D; &quot;_http._tcp.example.com. 86400 IN SRV 10 60 80 server.example.com.&quot; };
        ...
        {
            Console.WriteLine("📤 Calling SRV Record Parser API...\n");

            var result = await CallSRVRecordParserAPI();
